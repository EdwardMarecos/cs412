...
SECRET_KEY = 'django-insecure-p8%*-#x-v7awv*fuwd6_0&#29v$orn0$m52z6-p89-&t031b@a'
...
if IS_HEROKU:
    try:
        ...
        print(f"ERROR: Failed to import 'dj_database_url'. Please ensure the package is installed. Details: {e}")
        raise e
else:
    DATABASES = {
        'default': {
